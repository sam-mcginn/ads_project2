...
set_instance_assignment -name IO_STANDARD "3.3V LVTTL" -to reset_led

# locked LED assignment to LEDR1
set_location_assignment PIN_A9 -to locked_led
set_instance_assignment -name IO_STANDARD "3.3V LVTTL" -to locked_led

# VGA horizontal sync assignment
set_location_assignment PIN_N3 -to horz_sync
set_instance_assignment -name IO_STANDARD "3.3V LVTTL" -to horz_sync

# VGA vertical sync assignment
set_location_assignment PIN_N1 -to vert_sync
set_instance_assignment -name IO_STANDARD "3.3V LVTTL" -to vert_sync
...
for { set i 0 } { ${i} < 4 } { incr i } {
	...
	set_instance_assignment -name IO_STANDARD "3.3V LVTTL" -to r_out\[${i}\]
}
...
for { set i 0 } { ${i} < 4 } { incr i } {
	...
	set_instance_assignment -name IO_STANDARD "3.3V LVTTL" -to g_out\[${i}\]
}
...
for { set i 0 } { ${i} < 4 } { incr i } {
	...
	set_instance_assignment -name IO_STANDARD "3.3V LVTTL" -to b_out\[${i}\]
}